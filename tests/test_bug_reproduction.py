...
from api.models import CompetitorCandidate, BrandContext, Competitor
    ...
    for item in search_items:
        ...
        if not link or link not in seen:
            if link:  # Only add if link is valid
                ...
                print(f"    ✗ Skipped: empty or invalid link")
...
def test_before_fix_would_fail():
    ...
    try:
        ...
        print(f"    Unexpected: Competitor created (this shouldn't happen)")
    except Exception as e:
